    ...
    <div class="container">
      <div class="py-10 flex gap-6">
        ...
        <div class="w-[30%] bg-black shadow-xl h-max p-6">
          ...
          <div class="flex flex-col gap-3 border-b border-green-300 pb-4">
          ...
          <button class="bg-green-600 text-white text-base font-bold w-full py-2 rounded-lg">Checkout</button>
        </div>
      </div>
    </div>
  </section>
