export const products = [
    ...
    },
    {
      ...
      isCart: false,
      description: "Regular fit Denim design Classic collar Ventela Public Low Yellow The model is 187 cm tall and is wearing a size M",
    },
    {
      id: 3,
      name: "Men's Streetwear Fashion Style Big Pocket Cotton Long Sleeve Shirt Flannel Tenue de Attire BlackWhite/ XL",
      category: "Baju",
      price: 17,
      image: "/images/products/baju-3.png",
      isCart: false,
      description: "Black White Preppy Long Sleeve Polyester Plaid Shirt Non-Stretch Spring/Fall Men Tops",
    },
    {
      id: 4,
      name: "Amiri Logo Applique Jeans Clay Indigo, Gray - Size 34W/32L",
      category: "Celana",
      price: 16,
    ...
    {
      id: 5,
      name: "Batch Freelancer Men's Denim Hoodie Jacket Drawstring Black",
      category: "Baju",
      price: 10,
